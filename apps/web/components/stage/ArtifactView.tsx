          ...
          <ResponsiveContainer>
            {chartType === "line" ? (
              <LineChart data={data}>
                ...
                <XAxis dataKey={xKey} stroke="hsl(222 8% 45%)" fontSize={12} />
                <YAxis stroke="hsl(222 8% 45%)" fontSize={12} />
                <Tooltip contentStyle={{ background: "white", border: "1px solid hsl(40 10% 88%)" }} />
                <Legend />
                {yKeys.map((k, i) => (
